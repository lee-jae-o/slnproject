...
<div id="top-navbar" style="display: flex; justify-content: space-between; align-items: center; padding: 32px; ">
    <a style="font-size: 35px; color: white;">단백질</a>
    <div>
...
<iframe style="margin-left: 220px; margin-top: 20px"
        width="700" height="440" src="https://www.youtube.com/embed/MhAMa8YuK1U" frameborder="0"
...
<iframe style="margin-top: 20px; margin-right: 20px; margin-left: 40px"
        width="700" height="440" src="https://www.youtube.com/embed/2usx3CBczJE" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<iframe style="margin-left: 220px; margin-top: 120px"
        width="700" height="440" src="https://www.youtube.com/embed/k5iqC9LXLkI" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<iframe style="margin-top: 20px; margin-right: 20px; margin-left: 40px"
        ...
        width="700" height="440" src="https://www.youtube.com/embed/eCpzOOhvY2k" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<iframe style="margin-left: 220px; margin-top: 120px"
        ...
        width="700" height="440" src="https://www.youtube.com/embed/UQFZJISTymQ" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<iframe style="margin-top: 20px; margin-right: 20px; margin-left: 40px"
        width="700" height="440" src="https://www.youtube.com/embed/wCXwqW3M0Ig" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
