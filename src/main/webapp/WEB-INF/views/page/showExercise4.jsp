...
<div id="top-navbar" style="display: flex; justify-content: space-between; align-items: center; padding: 32px; ">
    <a style="font-size: 35px; color: white;">명상</a>
    <div>
...
<iframe style="margin-left: 220px; margin-top: 20px"
        width="700" height="440" src="https://www.youtube.com/embed/nJwyhqHATgw" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>


<iframe style="margin-top: 20px; margin-right: 20px; margin-left: 40px"
        width="700" height="440" src="https://www.youtube.com/embed/Rl6_OzuG73s" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>



<iframe style="margin-left: 220px; margin-top: 120px"
        width="700" height="440" src="https://www.youtube.com/embed/dZewQEbQQM0" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>


<iframe style="margin-top: 20px; margin-right: 20px; margin-left: 40px"
        width="700" height="440" src="https://www.youtube.com/embed/mluuIWlxixg" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

<iframe style="margin-left: 220px; margin-top: 120px"
        width="700" height="440" src="https://www.youtube.com/embed/OF1UccGXPWM" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

<iframe style="margin-top: 20px; margin-right: 20px; margin-left: 40px"
        width="700" height="440" src="https://www.youtube.com/embed/cvPS_25gRPs" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
